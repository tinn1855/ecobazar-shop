...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/mpi5h8BxjH)
...
```sh
npx nx serve ecobazar-shop
```

To create a production bundle:

```sh
npx nx build ecobazar-shop
```

To see all available targets to run for a project, run:

```sh
npx nx show project ecobazar-shop
```
